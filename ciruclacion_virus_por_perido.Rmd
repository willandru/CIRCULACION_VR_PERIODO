...
En el análisis del comportamiento de los virus respiratorios por periodo epidemiológico desde el `r tabla$AÑO[1]` se observa que se ha mantenido la circulación de virus como Rinovirus, Adenovirus y VSR. Para los tres años entre los periodos 3 al 6 coincide con el pico respiratorio que se presenta en todos los años (Figura 1).
